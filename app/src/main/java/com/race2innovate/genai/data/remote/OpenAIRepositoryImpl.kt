...
import com.race2innovate.genai.models.toJson
    ...
    override fun textCompletionsWithStream(params: TextCompletionsParam): Flow<String> =
        callbackFlow {
            withContext(Dispatchers.IO) {
                val response =
                    (if (params.isChatCompletions)
                        openAIApi.textCompletionsTurboWithStream(params.toJson())
                        ...
                        while (true) {
                            ...
                            if (line == "data: [DONE]") {
                                ...
                                try {
                                    ...
                                    e.printStackTrace()
                                    Log.e("GenAI LLM BUG", e.toString())
                                }
                            }
                        }
                    } catch (e: IOException) {
